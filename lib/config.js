...
// used to encrypt tokenizer secrets that are stored in tokenizer records
config.tokenizer.tokenizerRecordEncryption = {
  // current key encryption key for wrapping randomly-generated content
  // encryption keys used to encrypt tokenizer secrets at tokenizer record
  // creation time; existing tokenizer records w/o secrets encryption will be
